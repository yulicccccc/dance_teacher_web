...
| P0-7 1–8 数拍 + 脉冲 | rAF 驱动，节拍叠加层独立镜像；三音色节拍器提供 ½×/1×/2× 提示密度，第 1 拍重音，快拍由视频媒体时间穿越半拍中点触发 | `BeatOverlay.test.tsx`、`countVoiceAudio.test.ts`、`metronomeTiming.test.ts`、beat sync 测试 |
